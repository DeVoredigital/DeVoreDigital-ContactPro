...
namespace ContactPro.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string swalMessage = null)
        {
            ...
            List<Category> categories = await _context.Categories.Where(c=> c.AppUserId == appUserId)
                                                    .Include(c => c.AppUser)
                                                    .ToListAsync();
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            Category? category = await _context.Categories.Where(c => c.Id == id && c.AppUserId == appUserId)
                                                     .FirstOrDefaultAsync();  
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            Category? category = await _context.Categories.FirstOrDefaultAsync(c=>c.Id == id && c.AppUserId == appUserID);
